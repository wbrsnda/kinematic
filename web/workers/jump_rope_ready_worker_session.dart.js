...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _iterablePartsToStrings(iterable, parts) {
      var next, ultimateString, penultimateString, penultimate, ultimate, ultimate0, elision,
        t1 = iterable._map,
        it = new A.LinkedHashMapKeyIterator(t1, t1._modifications, t1._first, iterable.$ti._eval$1("LinkedHashMapKeyIterator<1>")),
        $length = 0, count = 0;
      while (true) {
    ...
    main() {
      var t2, t1 = {};
      A.printString("[Worker] Started.");
      t1.initialized = false;
      t2 = self;
      t2.toString;
      type$.DedicatedWorkerGlobalScope._as(t2);
      A._EventStreamSubscription$(t2, "message", type$.nullable_void_Function_MessageEvent._as(new A.main_closure(t1, t2)), false, type$.MessageEvent);
    },
  ...
  A.Iterable.prototype = {
    get$length(_) {
      var count,
        t1 = this._map,
        it = new A.LinkedHashMapKeyIterator(t1, t1._modifications, t1._first, this.$ti._eval$1("LinkedHashMapKeyIterator<1>"));
  ...
  A.main_closure.prototype = {
    call$1($event) {
      var copy, type, t3, data_back, _this = this,
      ...
      if (t2.$eq(type, "initialize") && !_this._box_0.initialized) {
        _this._box_0.initialized = true;
        t1 = type$.String;
        B.DedicatedWorkerGlobalScope_methods.postMessage$1(_this.workerScope, A.LinkedHashMap_LinkedHashMap$_literal(["type", "wait_for_data"], t1, t1));
        return;
      }
      if (t2.$eq(type, "frame")) {
        t2 = _this.workerScope;
        t3 = type$.String;
        B.DedicatedWorkerGlobalScope_methods.postMessage$1(t2, A.LinkedHashMap_LinkedHashMap$_literal(["type", "wait_for_data"], t3, t3));
        type$.Map_dynamic_dynamic._as(copy);
        A._asInt(t1.$index(copy, "frameId"));
        A._asInt(t1.$index(copy, "width"));
        A._asInt(t1.$index(copy, "height"));
        data_back = A.LinkedHashMap_LinkedHashMap$_literal(["type", "frame", "buffer", t1.$index(copy, "buffer"), "width", t1.$index(copy, "width"), "height", t1.$index(copy, "height"), "frameId", t1.$index(copy, "frameId"), "time", new A.DateTime(Date.now(), 0, false)], t3, type$.dynamic);
        t1 = t1.$index(copy, "buffer");
        B.DedicatedWorkerGlobalScope_methods.postMessage$2(t2, data_back, A._setArrayType([t1 == null ? type$.Object._as(t1) : t1], type$.JSArray_Object));
      }
    },
    $signature: 17
  };
...
//# sourceMappingURL=jump_rope_ready_worker_session.dart.js.map
